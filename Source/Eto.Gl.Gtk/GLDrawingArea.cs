...
namespace Eto.Gl.Gtk
{
    ...
    public class GLDrawingArea : DrawingArea, IDisposable
    {
        ...
        private bool init()
        {
			OpenTK.Toolkit.Init(new ToolkitOptions(){ Backend = PlatformBackend.PreferNative });
            ...
            else if (Configuration.RunningOnLinux)
            {
                ...
                IntPtr handle = GdkWindow.Handle;
                IntPtr windowHandle = gdk_x11_drawable_get_xid(GdkWindow.Handle);
        ...
        public void Refresh()
        {
            OnExposeEvent(new Gdk.EventExpose(IntPtr.Zero));
        }
